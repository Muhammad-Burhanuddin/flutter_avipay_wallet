...
class ShareMyQrWidget extends StatefulWidget {
  const ShareMyQrWidget({super.key});

  @override
  State<ShareMyQrWidget> createState() => _ShareMyQrWidgetState();
}

class _ShareMyQrWidgetState extends State<ShareMyQrWidget> {
