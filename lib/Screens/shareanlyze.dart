...
class ShareAnalyzeWidget extends StatefulWidget {
  const ShareAnalyzeWidget({super.key});

  @override
  State<ShareAnalyzeWidget> createState() => _ShareAnalyzeWidgetState();
}

class _ShareAnalyzeWidgetState extends State<ShareAnalyzeWidget> {
